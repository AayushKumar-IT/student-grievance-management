...
@Component({
  selector: 'app-college-admin-register',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterModule],
  templateUrl: './college-admin-register.component.html',
  styleUrls: ['./college-admin-register.component.css']
})
export class CollegeAdminRegisterComponent implements OnInit {
  form: FormGroup;
  loading = false;
  error = '';
  colleges: College[] = [];
  ...
  onSubmit(): void {
    ...
    this.authService.registerCollegeAdmin(payload).subscribe({
